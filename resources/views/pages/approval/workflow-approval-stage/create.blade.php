@section('content')
<form method="POST" action="{{ route('approval.workflow-approval-stage.store') }}">
@csrf
    <div class="modal-body">
        ...
        <div class="form-group">
            <input type="text" class="form-control" name="name" required value="{{ old('name') }}" placeholder="Nama tahap">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <input type="number" class="form-control" name="sequence" required value="{{ old('sequence', 1) }}" min="1">
        ...
        <div class="form-group">
            <select class="form-control" name="approval_logic" required>
                <option value="all" {{ old('approval_logic') == 'all' ? 'selected' : '' }}>ALL - Semua approver harus menyetujui</option>
                <option value="any" {{ old('approval_logic') == 'any' ? 'selected' : '' }}>ANY - Salah satu approver cukup</option>
            </select>
