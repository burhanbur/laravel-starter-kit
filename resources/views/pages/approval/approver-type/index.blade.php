...
@section('title', config('app.alias') . ' | Tipe Approver')
            ...
            <div class="kt-portlet__head">
                <div class="kt-portlet__head-label">
                    <h3 class="kt-portlet__head-title">
                        <i class="flaticon2-user"></i> &nbsp; Tipe Approver
                    </h3>
                </div>
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            <a href="javascript:void(0)" value="{{ route('approval.approver-type.create') }}" class="btn btn-icon btn-success modalInterval" data-bs-toggle="modal" title="Tambah Tipe Approver" data-bs-target="#modalInterval"><i class="la la-plus"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    <form action="{{ route('approval.approver-type.destroy', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <span class="tooltips" data-original-title="Ubah">
                                            <a href="javascript:void(0)" value="{{ route('approval.approver-type.edit', $item->id) }}" class="btn btn-sm btn-icon btn-info modalInterval" data-bs-toggle="modal" title="Ubah Tipe Approver" data-bs-target="#modalInterval"><i class="fa fa-edit"></i></a>
                                        </span>
