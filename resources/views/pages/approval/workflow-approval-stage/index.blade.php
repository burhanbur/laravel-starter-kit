...
@section('title', config('app.alias') . ' | Tahap Workflow Approval')
            ...
            <div class="kt-portlet__head">
                <div class="kt-portlet__head-label">
                    <h3 class="kt-portlet__head-title">
                        <i class="flaticon2-layers-1"></i> &nbsp; Tahap Workflow Approval
                    </h3>
                </div>
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            <a href="javascript:void(0)" value="{{ route('approval.workflow-approval-stage.create') }}" class="btn btn-icon btn-success modalInterval" data-bs-toggle="modal" title="Tambah Tahap Workflow" data-bs-target="#modalInterval"><i class="la la-plus"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-striped table-hover table-bordered" id="myDataTables" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <td class="text-center">Workflow Approval</td>
                                <td class="text-center">Urutan</td>
                                <td class="text-center">Level</td>
                                <td class="text-center d-none d-md-table-cell">Logika Persetujuan</td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle d-none d-md-table-cell">
                                    @if($item->approval_logic === 'all')
                                        <span class="badge badge-primary">Semua (ALL)</span>
                                    @else
                                        <span class="badge badge-warning">Salah Satu (ANY)</span>
                                    @endif
                                </td>
                                <td class="text-center align-middle">
                                    <form action="{{ route('approval.workflow-approval-stage.destroy', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <span class="tooltips" data-original-title="Ubah">
                                            <a href="javascript:void(0)" value="{{ route('approval.workflow-approval-stage.edit', $item->id) }}" class="btn btn-sm btn-icon btn-info modalInterval" data-bs-toggle="modal" title="Ubah Tahap Workflow" data-bs-target="#modalInterval"><i class="fa fa-edit"></i></a>
                                        </span>
