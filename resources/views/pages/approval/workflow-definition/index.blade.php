...
@section('title', config('app.alias') . ' | Workflow Definition')
            ...
            <div class="kt-portlet__head">
                <div class="kt-portlet__head-label">
                    <h3 class="kt-portlet__head-title">
                        <i class="flaticon2-settings"></i> &nbsp; Workflow Definition
                    </h3>
                </div>
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            <a href="javascript:void(0)" value="{{ route('approval.workflow-definition.create') }}" class="btn btn-icon btn-success modalInterval" data-bs-toggle="modal" title="Tambah Workflow Definition" data-bs-target="#modalInterval"><i class="la la-plus"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table table-striped table-hover table-bordered" id="myDataTables" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <td class="text-center d-none d-md-table-cell">Deskripsi</td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center align-middle">
                                    <form action="{{ route('approval.workflow-definition.destroy', $item->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <span class="tooltips" data-original-title="Ubah">
                                            <a href="javascript:void(0)" value="{{ route('approval.workflow-definition.edit', $item->id) }}" class="btn btn-sm btn-icon btn-info modalInterval" data-bs-toggle="modal" title="Ubah Workflow Definition" data-bs-target="#modalInterval"><i class="fa fa-edit"></i></a>
                                        </span>
