...
@method('PUT')
	...
	<div class="modal-body">
		...
		<div class="form-group">
			<input type="text" class="form-control" name="name" required value="{{ old('name', $data->name) }}" placeholder="Masukkan nama lengkap">
			@error('name')
		...
		<div class="form-group">
			<input type="text" class="form-control" name="username" required value="{{ old('username', $data->username) }}" placeholder="Masukkan username">
			@error('username')
				<small class="text-danger">{{ $message }}</small>
			@enderror
		</div>
		...
		<div class="form-group">
			<input type="email" class="form-control" name="email" required value="{{ old('email', $data->email) }}" placeholder="Masukkan email">
			@error('email')
				<small class="text-danger">{{ $message }}</small>
			@enderror
		</div>
		...
		<div class="form-group">
			<input type="text" class="form-control" name="phone" value="{{ old('phone', $data->phone) }}" placeholder="Masukkan nomor telepon">
			@error('phone')
				<small class="text-danger">{{ $message }}</small>
			@enderror
		</div>
